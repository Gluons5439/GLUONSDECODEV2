...
public class Blue24 extends CommandOpMode {
    ...
    public void initialize() {
        ...
        Mosby.init(hardwareMap, Mosby.MatchState.AUTO, Mosby.Alliance.BLUESQ);
        paths2 = new Paths2(Mosby.drivetrain.follower, Mosby.Alliance.BLUESQ);
        ...
        schedule(new SequentialCommandGroup(
               ...
               // new SequentialCommandGroup(
                        new InstantCommand(() -> Mosby.intake.setPower(1)),
                        new InstantCommand(() -> Mosby.drivetrain.follower.setMaxPower(0.9)),
